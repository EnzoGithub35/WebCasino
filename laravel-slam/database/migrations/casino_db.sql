...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 03 oct. 2024 à 09:47
...
CREATE TABLE IF NOT EXISTS `blackjack` (
  ...
  `HeureDebutPartie` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`),
...
CREATE TABLE IF NOT EXISTS `gamename` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `NomJeu` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`),
  UNIQUE KEY `Id_UNIQUE` (`Id`)
...
CREATE TABLE IF NOT EXISTS `games_history` (
  ...
  `GameName` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Resultat` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Points` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`),
  UNIQUE KEY `Id_UNIQUE` (`Id`)
...
CREATE TABLE IF NOT EXISTS `statistic` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `IdJoueur` int NOT NULL,
  `StatLabel` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `pseudo` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
